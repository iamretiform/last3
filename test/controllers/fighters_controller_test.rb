...
class FightersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create fighter" do
    assert_difference('Fighter.count') do
      post fighters_url, params: { fighter: { age: @fighter.age, height: @fighter.height, name: @fighter.name, weight: @fighter.weight } }
    end
  ...
  test "should update fighter" do
    patch fighter_url(@fighter), params: { fighter: { age: @fighter.age, height: @fighter.height, name: @fighter.name, weight: @fighter.weight } }
